...
export async function upsertPairwiseToken({internalId, requester}) {
  ...
  while(true) {
    ...
    try {
      const record = await getPairwiseToken({internalId, requester});
      return record;
    } catch(e) {
...
export async function getPairwiseToken({

...
*/
  ...
  // TODO: need to resolve potential mismatch between current tokenizer and
  // `version` ... or automatically make a new version based on the current
  // tokenizer and configuration options if such a version has not yet
  // been created ... might want the version options to come from the database
  // instead of from the config file ... or might want them to inherit the
  // previous version values ... need an external control on version
  // parameters

  // TODO: use p-* promises-fun to limit concurrency as needed
  for(let i = 0; i < count; ++i) {
    _create({tokenizer, internalId, attributes})

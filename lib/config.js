...
config.tokenization.defaultVersionOptions = {
  ...
  // note that the max configurable value here is 256 with the current
  // implementation -- the implementation must change to use a larger token
  // batch resolution bitstring to allow larger batches
  batchTokenCount: 100,

...
// built-in MongoDB TTL indexes or not (true = yes, false = no); if this is
// set to `false` on a system where it was previously set to `true`, then
// any instance running with this configuration will delete existing TTL
// indexes; setting it to `true` on a system where it was previously `false`
// will result in the creation of new TTL indexes
config.tokenization.autoRemoveExpiredRecords = true;

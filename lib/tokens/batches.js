...
// FIXME: add API to reset `minAssuranceForResolution` to a given value *if*
// there is no open unpinned token batch for the given entity; determine if
// the `batchInvalidationCount` needs to be set or not ... it should be that
// we ensure that `minAssuranceForResolution` has not changed

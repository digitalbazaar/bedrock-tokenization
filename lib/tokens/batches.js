...
// initial bitstring for batchIndexSize=1 (i.e., a compressed bitstring of
// all cleared bits with a length of 256, able to track token resolutions for
// token batches with a max size of 256 tokens -- default token batch size is
// only 100 so it will fit)

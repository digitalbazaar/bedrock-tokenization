...
/**
 * Retrieves the count of entities matching the given query.
 *
 * @param {object} options - The options to use.
 * @param {object} [options.query={}] - The query to use.
 *
 * @returns {Promise<number>} Resolves to the total count of entities that
 *   matched the query.
 */
...
/**
 * Retrieves the total count of entity records.
 *
 * @returns {Promise<number>} Resolves to the total count of entity records.
 */

 ...
 * @param {string} [options.internalId] - An optional internal ID to use, if
 ...
 * @param {string} [options.externalIdHash] - Optionally previously hashed
 *   (tokenized) externalId.
 * @param {string} [options.documentHash] - Optionally previously hashed
 *   (tokenized) document.
 * @param {string} [options.creatorHash] - Optionally previously hashed
 *   (tokenized) creator.
 ...
 *
 * @returns {string} A random `internalId`.
 */
export async function _generateInternalId() {
  return idEncoder.encode(await idGenerator.generate());
}
 ...
 *
 * @returns {object} The tokenized registration information.
 */

...
bedrock.events.on('bedrock-mongodb.ready', async () => {
  ...
  await database.createIndexes([{
    ...
    // queries based on that field alone are rare; they are not run in hot code
    // paths nor do they need to run quickly -- so the index cost is not
    // justified
 ...
 *   JWE or an ExplainObject if `explain=true`.
 */

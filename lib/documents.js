 ...
 * @param {boolean} [options.updateTokenBatch] - Specify whether or
 *   not to update token batch.
 *
...
export async function register({
  ...
  documentHash, creatorHash, newRegistration, updateTokenBatch
} = {}) {
...
async function _refresh({
  externalIdHash, documentHash, ttl, creatorHash, minAssuranceForResolution = 1
}) {
  const query = {
    'registration.externalIdHash': externalIdHash,
    'registration.documentHash': documentHash

...
/**
 * Sets the `minAssuranceForResolution` on the registration associated
 *   `internalId`.
 *
 * @param {object} options - Options to use.
 * @param {string} options.internalId - The internal ID of the registration.
 * @param {number} options.minAssuranceForResolution - Minimum level of
 *   assurance required for token resolution.
 *
 * @returns {Promise<boolean>} Returns true if update occurred.
 */
export async function setMinAssuranceForResolutionOnRegistration({
